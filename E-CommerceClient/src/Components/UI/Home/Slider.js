...
<header class="slider slider-prlx o-hidden" >
            ...
            <div class="swiper-container parallax-slider">
                <div class="swiper-wrapper">
                    ...
                    <div class="bg-img valign" data-background="Light/assets/imgs/black.jpg"
                            data-overlay-dark="7">
                            <div class="container">
                                <div class="row justify-content-center">
                                    <div class="col-lg-10">
                                        <div class="caption text-center">
                                            ...
                                            <a href="page-about.html" class="butn butn-md butn-bg main-colorbg3  mt-30">
                                                Get Solutions
                    ...
                    <div class="swiper-slide">
                        <div class="bg-img valign" data-background="Light/assets/imgs/background.jpg"
                            data-overlay-dark="7">
                            <div class="container">
                                <div class="row justify-content-center">
                                    <div class="col-lg-10">
